...
# Krížová validácia
cv_scores = cross_val_score(etc_model, X_train, y_train, cv=5)  # 5-násobná krížová validácia
...
def evaluate_model(model, X_val, y_val, X_test, y_test):
    ...
    plt.ylabel("Accuracy")
    plt.legend()
    plt.savefig("accuracy_curve_etc.png")
    plt.close()


# Zavolanie funkcie na vyhodnotenie
evaluate_model(etc_model, X_val, y_val, X_test, y_test)
