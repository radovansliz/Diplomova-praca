...
def run_xgboost_pipeline(X, y, config, evaluate_flag=True):
    ...
    if evaluate_flag:
        evaluate_model(xgb_clf, X_train, y_train, X_test, y_test, config, val_accuracy, test_accuracy, cv_scores, FP_val, FN_val, TP_val, TN_val, FPR_val, FP_test, FN_test, TP_test, TN_test, FPR_test)
...
if __name__ == "__main__":
    ...
    run_xgboost_pipeline(X, y, config, evaluate_flag=EVALUATE_MODEL)
