...
adaboost_model = AdaBoostClassifier(
    estimator=DecisionTreeClassifier(max_depth=3, random_state=42),  # Zvýšená hĺbka
    n_estimators=100,  # Zvýšený počet slabých klasifikátorov
    learning_rate=0.1,  # Znížená rýchlosť učenia
    random_state=42
)
...
with open("model_results.txt", "w") as f:
    f.write(f"Mean CV Score: {mean_cv_score:.4f}\n")
